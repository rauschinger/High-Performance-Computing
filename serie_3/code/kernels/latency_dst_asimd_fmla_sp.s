        .text
        .type latency_dst_asimd_fmla_sp, %function
        .global latency_dst_asimd_fmla_sp
        /*
         * Microbenchmark measuring achievable performance using fmla instructions.
         * Repeats 30 dependent SP ASIMD-FMAs regarding the destination.
...
loop_repeat:
        ...
        ret
        .size latency_dst_asimd_fmla_sp, (. - latency_dst_asimd_fmla_sp)
